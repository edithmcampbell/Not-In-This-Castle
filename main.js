...
//			console.log("FALL");
        ...
        if (this.bg.x <= -3200 && this.x >= 700 && this.key && !this.game.win && this.bg.level%2 !== 0) {
...
//            console.log(this.level);
            ...
            var gmb = new Goomba(this.game, goombaSprites, this.bg, 3500, 600, 3000, 3600);
            enemies.push(gmb);
